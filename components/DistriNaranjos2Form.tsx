    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {showOrderSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[100]">
          <div className="bg-white rounded-2xl shadow-2xl px-8 py-8 flex flex-col items-center max-w-sm w-full border-4 border-blue-600 relative">
            <svg className="w-16 h-16 text-blue-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
            <h2 className="text-2xl font-bold text-blue-700 mb-2 text-center">¡Pedido enviado con éxito!</h2>
            ...
            <a
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors text-base shadow-sm border border-blue-700 text-center mb-2"
